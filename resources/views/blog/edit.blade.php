                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('blog.update',$blog->slug) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ $blog->title }}" autocomplete="title" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control @error('body') is-invalid @enderror" name="body" id="body" cols="30" rows="10">{{$blog->body}}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="tag_ids[]" multiple class="form-control @error('tag_ids') is-invalid @enderror">
                                    ...
                                    @foreach($tags as $tag)
                                    <option @if(in_array($tag->id,$blog->tagIds()))
                                        selected
                                        @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <img src={{"/storage/blogs/{$blog->image}"}} width="100" />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="datetime-local" name="published_at" value="{{$blog->published_at}}" class="form-control" />
